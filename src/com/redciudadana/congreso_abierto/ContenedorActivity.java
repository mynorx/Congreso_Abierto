...
public class ContenedorActivity extends ActionBarActivity implements NavigationDrawerFragment.NavigationDrawerCallbacks 
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		//Se llama a la funcion setUp para la configuracion del NavigationDrawer
	...
	public void onSectionAttached(int number) {
		...
		case 1:
			mTitle = getString(R.string.opcion1);
			break;
		case 2:
			mTitle = getString(R.string.opcion2);
			break;
		case 3:
			mTitle = getString(R.string.opcion3);
			break;
		case 4:
			mTitle = getString(R.string.opcion4);
			break;
		case 5:
			mTitle = getString(R.string.opcion5);
			break;
		case 6:
			mTitle = getString(R.string.opcion6);
			break;
		}
	}
